...
proba_uczaca <- subset(proba_uczaca, select = -c(payclickedtime_imp,time_difference,createtime,payclickedtime))
...
proba_uczaca$level <- recode(proba_uczaca$level,
                             "WORLD"="WORLD","WORLD"="WORLD BLACK", "WORLD"="CLASSIC","WORLD"="WORLD BLACK EDITION","WORLD"="NEW WORLD",
