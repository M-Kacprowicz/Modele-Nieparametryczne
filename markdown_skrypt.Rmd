...
W zbiorze danych, niektóre wartości zmiennej `amount` mogą znacznie wpływać na wyniki modelu ze względu na wyjątkowo duże wartości. Zdecydowano żeby odrzucić wartości skrajne w rekordach ze zmienną `amount` odbiegających od średniej o 3 odchylenia.
...
## prosty model MARS
```{r}
# Usunięcie zmiennej status ze względu na jej brak w zmiennej proba_testowa
