...
Usunięcie zmiennych nieistotnych takich jak `screenheight`, `screenwidth`,`payclickedtime`,`id`,`initialtransaction_id`, `recurringaction`
oraz zmiennych, które zostały wykorzystane do tworzenia nowych zmiennych `expirymonth`,`expiryyear`,`time_to_expire`,`createtime`,`month_createtime`
...
```
Został utworzony podstawowy model MARS, którego Wynik `GCV = 1857.408`
...
Utworzono 4 modeli MARS z różnymi parametrami. Po analizie wyników do predykcji użyty zostanie model MARS `mars1`.
