...
Dane zostały posegregowane według kategori w celu ustrukturyzowania drzewa i ustandaryzowania ilości zmiennych znajdujących się w próbie.
```{r, echo=FALSE}
...
## Podzielenie zbioru na walidacyjny i uczący
...
# Ustalić optymalne wartości parametrów ('nk', 'minspan', 'thresh')
 ...
 gcv.nk <- sapply(seq(40, 90, 10), function(x)
...
pred = predict(mars3,proba_testowa,type="earth")
